...
#         # Define possible moves. These simulate key presses:
#         #   K_LEFT / K_RIGHT - move piece left or right
#         #   K_UP - rotate piece
#         #   K_DOWN - move piece down faster
#         #   K_SPACE - hard drop
#         #   K_c - hold piece
#         possible_moves = [pygame.K_LEFT, pygame.K_RIGHT, pygame.K_UP, pygame.K_DOWN, pygame.K_SPACE, pygame.K_c]

#         while True:
#             try:
#                 timepassed = clock.tick(50)
#                 pygame.time.wait(200)
#                 # Inject a random "key press" event every frame
#                 # This will cause a random move
#                 move = random.choice(possible_moves)
#                 pygame.event.post(pygame.event.Event(pygame.KEYDOWN, {'key': move}))
